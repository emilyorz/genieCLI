...
| -------------- | -------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| trino-research | [features/trino-research.md](features/trino-research.md) | v35 (write-operation analysis-only mode for `/trino-research`; TLV4 Codex DONE) |
| mcp-banner     | [features/mcp-banner.md](features/mcp-banner.md)         | v26 (fast-fail 200ms probe; 14× cold-start improvement)                                                                                      |

## Archive

- [archive/v35.md](archive/v35.md) — write-operation analysis-only mode for `/trino-research` (Task-Ledger-V4 Codex DONE): chat `--file` early write dispatch before MCP reachability, direct/MCP entrypoint guards, import-safe `write_analysis.py`, reports under `./report/trino-research-write-analysis-<ts>.md`; full suite **933 pass**
